...
require_once 'function.php';
	...
	?>
		<div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar" role="navigation">
          <div class="list-group">
            ...
            <a href="<?php echo "org_calendar.php?org=".$org_name ?>" class="list-group-item <?php if($page == 2) echo "active";?>">Calendar</a>
    ...
    ?>
        <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar" role="navigation">
          <div class="list-group">
            <a href="dash_index.php" class="list-group-item <?php if($page == 0) echo "active";?>">Personal Info</a>
            <a href="dash_events.php" class="list-group-item <?php if($page == 1) echo "active";?>">My Events</a>
            <a href="dash_career.php" class="list-group-item <?php if($page == 2) echo "active";?>">My Career</a>
            <a href="dash_scholarship.php" class="list-group-item <?php if($page == 3) echo "active";?>">My Scholarships</a>
            <a href="dash_feedback.php" class="list-group-item <?php if($page == 4) echo "active";?>">My Feedbacks</a>
            <a href="dash_security.php" class="list-group-item <?php if($page ==5) echo "active";?>">Security Settings</a>
          </div>
        </div><!--/span-->
    <?php
    }
    ...
    ?>
        <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar" role="navigation">
          <div class="list-group">
            <a href="<?php echo $_SERVER['PHP_SELF'] ?>" class="list-group-item <?php if($page == "") echo "active";?>">All Events</a>
            <?php
              ...
              while ($org_info = $data -> fetch_array()) {
                ...
                <a href="<?php echo $_SERVER['PHP_SELF'].'?org='.$my_org_name; ?>" class="list-group-item <?php if($page == $my_org_name) echo "active";?>">
                  <?php echo $my_org_name; ?>
                </a>
              <?php }
            ?>
            <a href="<?php echo $_SERVER['PHP_SELF'].'?org=Others' ?>" class="list-group-item <?php if($page == 'Others') echo "active";?>">Others</a>
          </div>
        </div><!--/span-->
    <?php
    }
    ...
    ?>
        <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar" role="navigation">
          <div class="list-group">
            <a href="<?php echo $_SERVER['PHP_SELF'] ?>" class="list-group-item <?php if($page == "") echo "active";?>">All Scholarships</a>
            <a href="<?php echo $_SERVER['PHP_SELF'].'?cat=undergraduates' ?>" class="list-group-item <?php if($page == 'undergraduates') echo "active";?>">Undergraduates</a>
            <a href="<?php echo $_SERVER['PHP_SELF'].'?cat=graduates' ?>" class="list-group-item <?php if($page == 'graduates') echo "active";?>">Graduates</a>
            <a href="<?php echo $_SERVER['PHP_SELF'].'?cat=My Scholarships' ?>" class="list-group-item <?php if($page == 'My Scholarships') echo "active";?>">My Scholarships</a>
            <a href="<?php echo $_SERVER['PHP_SELF'].'?cat=feedback' ?>" class="list-group-item <?php if($page == 'feedback') echo "active";?>">Feedback</a>
          </div>
        </div><!--/span-->
    <?php
    }
    ...
    ?>
        <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar" role="navigation">
          <div class="list-group">
            <a href="<?php echo $_SERVER['PHP_SELF'] ?>" class="list-group-item <?php if($page == "") echo "active";?>">All Career info</a>
            <a href="<?php echo $_SERVER['PHP_SELF'].'?cat=fulltime' ?>" class="list-group-item <?php if($page == 'fulltime') echo "active";?>">Fulltime</a>
            <a href="<?php echo $_SERVER['PHP_SELF'].'?cat=internship' ?>" class="list-group-item <?php if($page == 'internship') echo "active";?>">Internship</a>
            <a href="<?php echo $_SERVER['PHP_SELF'].'?cat=My Career' ?>" class="list-group-item <?php if($page == 'My Career') echo "active";?>">My Career</a>
            <a href="<?php echo $_SERVER['PHP_SELF'].'?cat=feedback' ?>" class="list-group-item <?php if($page == 'feedback') echo "active";?>">Feedback</a>
          </div>
        </div><!--/span-->
    <?php
	...
	function gen_footer($title='UM-SJTU JI Student Affairs')
	{
		?>
		<footer>
            <p>&copy; <?php echo $title ?><?php check_by_360(); ?> | developed by <a href="http://ji.sjtu.edu.cn/student/org_member.php?org=Advising&memberID=5123709184">Peng</a> and Zhuangzhuang</p>
        </footer>
	<?php
	}
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        ...
        name="phone" value="<?php if(isset($_SESSION['userphone'])){echo $_SESSION['userphone'];} ?>">
      </div>
    </div>
    <div class="form-group">
      <label class="col-sm-2 control-label">Email</label>
      <div class="col-sm-6">
        <input type="text" class="form-control required email" id="reg_email" placeholder="eg. example@example.com" 
    ...
    ?>
    <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="<?php echo $_SERVER['PHP_SELF'].'?'.$_SERVER['QUERY_STRING'];?>">
    <fieldset>
    <div class="form-group">
      <label class="col-sm-2 control-label">Name</label>
      <div class="col-sm-6">
    ...
    <div class="form-group">
      ...
      <div style="padding-top: 6px" class="col-sm-12">
            <?php 
                ...
                ."' COLLATE utf8_bin AND table_name='".$table_id_info['table_name']."' COLLATE utf8_bin AND upload_by_user_id='".mysqli_real_escape_string($dbc, $_SESSION['user_id'])
                ...
                <a href="<?php echo $_SERVER['PHP_SELF'].'?'.$table_id_info['id_name'].'='.$key_id.'&rmfile='.$one_file['file_link'].'&CSRFcheck='.$_SESSION['CSRFcheck']; ?>">Remove</a>
                </p>
                <?php
                }
            ?>
    ...
    { 
      $query = "SELECT * FROM Scholarships WHERE status='published' AND scholarship_id='".mysqli_real_escape_string($dbc, $scholarship_id)."' COLLATE utf8_bin";
      ...
      <div class="row">
        ...
        <h4><strong>Contacts: </strong><a href="mailto:<?php echo $scholarship_info['contact_email'];?>"><?php echo $scholarship_info['contact_email'];?></a></h4>
    ...
    { 
      $query = "SELECT * FROM Career WHERE status='published' AND career_id='".mysqli_real_escape_string($dbc, $career_id)."' COLLATE utf8_bin";
      $result = mysqli_query($dbc,$query);
      if ($result) {
        $scholarship_info = $result->fetch_array();
      }
    ...
    { ?>
      ...
      <div class="form-group">
        ...
        <div class="form-group">
          <label class="col-sm-2 control-label">Email</label>
          <div class="col-sm-6">
            <input type="text" id="feedback_email" class="form-control required email" placeholder="eg. example@example.com" 
            name="email" value="<?php if(isset($_SESSION['useremail'])){echo $_SESSION['useremail'];} ?>">
          </div>
        </div>
        <div class="form-group">
    ...
    {
      $query = "SELECT * FROM Events WHERE event_id='".mysqli_real_escape_string($dbc, $event_id)."' COLLATE utf8_bin AND status='published'";
        $result = mysqli_query($dbc,$query);
        if ($result) {
        ...
        <div class="col-xs-12 col-sm-12">
          ...
          <div class="row">
            ...
            <?php } else { ?>
              ...
              <h4><strong>Contact us: </strong><a href="mailto:<?php echo $event_info['contact_email'];?>"><?php echo $event_info['contact_email'];?></a></h4>
              </div>
            <?php } ?>
