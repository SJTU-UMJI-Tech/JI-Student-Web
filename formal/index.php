...
<html lang="en">
  ...
  <body role="document">
      ...
      <div class="jumbotron">
        ...
        <p>This website is aiming at providing a collection of information to JI students, in student organizations, career development, scholarships and many other aspects. The website is still under developing, and thus we will be grateful if you could give us some <a href="feedback.php">feedback</a>. </p>
      </div>
      <hr>
    <div class="row-fluid">
      <div class="span12">
        <div class="box">
          <div class="box-content box-nomargin">
            ...
            <?php foreach ($GLOBALS['all_orgs'] as $key => $value): ?>
              <div class="col-sm-2">
                <input type="checkbox" checked="checked" name="e<?php echo $key ?>" id="e<?php echo $key ?>" />
    ...
    <div class="row">
      <div class="col-md-10">
        <h2>Organizations</h2>
        <h4>This section will contain most of student organizations here, including there description and member information.</h4>
      </div>
    </div>
    <hr>
    <div class="row">
      ...
      <div class="col-md-2" style="padding-top: 30px">
        <a href="events.php"><button class="btn btn-default">Take a look</button></a>
      </div>
    </div>
    <hr>
    <div class="row">
      ...
      <div class="col-md-2" style="padding-top: 30px">
        <a href="career.php"><button class="btn btn-default">Take a look</button></a>
      </div>
    </div>
    <hr>
    <div class="row">
      ...
      <div class="col-md-2" style="padding-top: 30px">
        <a href="scholarships.php"><button class="btn btn-default">Take a look</button></a>
      </div>
    </div>
    <hr>
    <div class="row">
      ...
      <div class="col-md-2" style="padding-top: 30px">
        <a href="dash_index.php"><button class="btn btn-default">Take a look</button></a>
      </div>
    </div>
	  <?php
	  $org_info = array();
    ...
    $(document).ready(function() {
      ...
      $("<?php foreach ($GLOBALS['all_orgs'] as $key => $value) {
        ...
        <?php $idx = 0; foreach ($GLOBALS['all_orgs'] as $key => $value): ?>
          if ($('#e<?php echo $key; ?>').is(':checked') == true) {newSource[<?php echo $idx;?>] = "cal_data.php?org=<?php echo $value; ?>&";} else {newSource[<?php echo $idx; $idx ++;?>] = ""};
        <?php endforeach ?>
